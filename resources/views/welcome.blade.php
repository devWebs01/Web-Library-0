            ...
            <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                <div class="col-10 col-sm-8 col-lg-6">
                    <img src="https://cdn.livecanvas.com/media/svg/pixeltrue/blogging.svg"
                        class="d-block mx-lg-auto img-fluid wp-image-1461" alt="" loading="lazy" width="640" height="">
                </div>
                <div class="col-lg-6">
        ...
        <div class="container pb-5 pt-5">
            <div class="pb-5 pt-5 row">
                <div class="col-lg-9 col-xl-8 ms-auto me-auto pb-5 pt-5">
                    ...
                    <p class="lead mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque blandit tellus
                        eu.</p><a class="btn btn-lg btn-primary" href="">Learn more</a>
                </div>
            </div>
        </div>
    </section>
